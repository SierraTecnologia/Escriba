...
use Escritor\Services\StoreLogistics;
use Escritor\Models\Coupon;
use Escritor\Models\Currency;
use Escritor\Models\Variant;
use Escritor\Repositories\CartRepository;
use Escritor\Repositories\CartSessionRepository;
use Escritor\Repositories\TransactionRepository;
use Escritor\Services\Concerns\CartHtmlGenerator;
...
class CartService
{
    ...
    */
    ...
    public function getCartSubTotal()
    {
        ...
        if (config('escritor.taxes_include_shipping')) {
