...
class ProductService
{
    ...
    */
    ...
    {
        return view('escritor::products.details', ['product' => $product])->render();
    }
    ...
    public static function variants($product)
    {
        ...
        foreach ($variants as $variant) {
            if (self::isArrayVariant($variant->value)) {
                $variantHtml .= view('escritor::products.variants.select', ['variant' => $variant])->render();
            } else {
                $variantHtml .= view('escritor::products.variants.other', ['variant' => $variant])->render();
            }
        }
