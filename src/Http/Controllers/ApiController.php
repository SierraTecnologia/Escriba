...
class ApiController extends SitecController
{
    ...
    public function __construct(Request $request)
    {
        ...
        if (! empty($this->modelName)) {
            ...
            if (class_exists('Escritor\Models\\'.$this->getFeature($this->modelName).'\\'.ucfirst($this->modelName))) {
                $this->model = app('Escritor\Models\\'.$this->getFeature($this->modelName).'\\'.ucfirst($this->modelName));
            } else {
