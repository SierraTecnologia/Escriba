...
use Escritor\Models\Code\Escritor;
use Yajra\Datatables\Datatables;
use Facilitador\Exceptions\Exception;
use Pedreiro\Http\Controllers\Admin\Base;

class EscritorController extends Base
{
    /**
     * @var string
     */
    public $title = 'Escritors';
    public $model = Escritor::class;

    /**
     * @var string
     */
    public $description = 'Listagem de Escritors.';
    ...
    //         'admin.orders.index', [
    //         'orders' => Escritor::orderBy('id', 'DESC')->simplePaginate(50),
    //         ]
    //     );
    // }
    ...
    // {
    //     // if ($request->ajax()) {
    //     //     $query = Escritor::with('user', 'operadora', 'collaborator', 'customer', 'money')->select('orders.*');
    ...
    //     //         return $order->status == Escritor::$STATUS_APPROVED ? 'alert-success' : 'alert-warning';
    //     //     })
    //     //     ->setRowData([
    //     //         'id' => 'test',
    //     //     ])
    ...
    //     // }
    //     // return view('escritor::admin.orders.index');
    ...
    //         dd('oi');
    //         $orders = Escritor::search($request->input('query'))->orderBy('id', 'DESC')->simplePaginate(50);
    //     } else {
    //         $orders = Escritor::orderBy('id', 'DESC')->simplePaginate(50);
    //     }
    //     return view('escritor::admin.orders.index', compact('orders'));
    // }
    ...
    // {
    //     return view('escritor::admin.orders.create');
    // }
    ...
    // {
    //     $order = Escritor::findOrFail($id);
    //     return view('escritor::admin.orders.show', compact('order'));
    // }
    ...
    // {
    //     $order = Escritor::find($id);

    //     return view('escritor::admin.orders.edit', compact('order'));
    // }
