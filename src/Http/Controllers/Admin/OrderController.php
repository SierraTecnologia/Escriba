...
class OrderController extends SitecController
{
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('escritor::admin.orders.edit')->with('order', $order);
    }
    ...
    public function cancel(Request $request)
    {
        ...
        if ($result) {
            return redirect(config('escritor.admin-route-prefix', 'admin').'/orders')->with('success', 'Successfully cancelled');
        }

        return redirect(config('escritor.admin-route-prefix', 'admin').'/orders')->with('error', 'Failed to cancel');
    }
}
