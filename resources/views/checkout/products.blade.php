...
<table class="table table-stripped mt-4">
    <tr>
        ...
        <td class="text-right">${!! escritor()->checkoutShipping() !!}</td>
    </tr>
    <tr>
        <td><b>Tax</b></td>
        <td class="text-right">${!! escritor()->checkoutTax() !!}</td>
    </tr>
    <tr>
        <td><b>Subtotal</b></td>
        <td class="text-right">${!! escritor()->checkoutSubtotal() !!}</td>
    </tr>
    ...
    <tr>
        ...
        <td class="text-right">-${!! escritor()->couponValue() !!}</td>
    </tr>
    @endif

    <tr>
        <td><b>Total</b></td>
        <td class="text-right">${!! escritor()->checkoutTotal() !!}</td>
    </tr>
</table>