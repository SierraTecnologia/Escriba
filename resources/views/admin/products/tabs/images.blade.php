...
<div class="row raw-margin-bottom-48">
    @foreach($images as $image)
        <div class="col-md-3 image-panel raw-margin-top-24">
            <div class="thumbnail">
                <a href="{!! route('admin.escritor.images.edit', [$image->id]) !!}">
            ...
            <div data-id="{{ $image->id }}" class="well pull-down overflow-hidden">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <a class="btn btn-sm btn-secondary float-right img-alter-btn raw-margin-right-8" href="{!! route('admin.escritor.images.edit', [$image->id]) !!}"><i class="fa fa-edit"></i></a>
                    </div>
                </div>
            </div>
        </div>
