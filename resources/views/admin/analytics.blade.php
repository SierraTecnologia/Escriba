...
<div class="col-md-12">
    ...
    <div class="row raw-margin-bottom-24">
        <div class="col-md-12">
            ...
            @else
                @include('escritor::analytics.transaction-table')
            @endif
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @else
                @include('escritor::analytics.subscription-table')
            @endif
        </div>
    </div>
</div>
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ Escritor::moduleAsset('js/analytics.js', 'application/javascript') }}"></script>
@endsection