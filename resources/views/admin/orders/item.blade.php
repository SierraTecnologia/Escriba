...
@section('content')
    ...
    <div class="col-md-12 mt-4">
        ...
        @include('escritor::admin.orders.breadcrumbs', ['location' => [['Order' => url('admin'.'/orders/'.$orderItem->order_id.'/edit')], 'item']])
            ...
            <div class="col-md-6 raw-margin-bottom-24">
                <table class="table table-sitecpaymentd">
                    <tbody>
                        <tr>
                            <th>Product</th>
                            <td class="text-right"><a href="{!! route('admin.escritor.products.edit', [$orderItem->product_id]) !!}">{{ ucfirst($orderItem->product->name) }}</a></td>
                        </tr>
                        <tr>
                            <th>Quantity</th>
